...
class TugboatAPI:
    ...
    def _create_vars(self):
        ...
        if (
            ...
            self.gcp_stor_client, self.gcp_bucket_name, self.gcp_bucket = cloud_utils.setup_gcp_storage_objs()
    ...
    def _get_tugboat_credentials(self):
        ...
        cred_file = cloud_utils.download_file_from_gcp(gcp_bucket=self.gcp_bucket, blob_file_path="ggn-nmfs-aa-dev-1-data/other/tugboat_credentials.json",local_file_path=local_creds_file_path,debug=False)
